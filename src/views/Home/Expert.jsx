...
const postData = [
    {
        ...
        name: 'Shoo Thar Mien',
        imgSrc: '../../assets/images/Expert/boyone.svg',
    },
    {
        profession: 'Junior Chef',
        name: 'Shoo Thar Mien',
        imgSrc: '../../assets/images/Expert/girl.png',
    },
    {
        profession: 'Junior Chef',
        name: 'Shoo Thar Mien',
        imgSrc: '../../assets/images/Expert/boytwo.svg',
    },
    {
        profession: 'Junior Chef',
        name: 'Shoo Thar Mien',
                            ...
                            <div key={i}>
                                <div className='m-3 py-14 my-10 text-center'>
                                    <div className="relative">
                                        <img  src={items.imgSrc} alt="logo" style={{width: "362px", height: "262px"}} />
                                        <div className="absolute top-[50%] right-[2%]">
                                            <img src="../../assets/images/Expert/Linkedin.svg" alt="logo" style={{width: "220px", height: "120px"}} />
                                        </div>
                                    </div>
